...
### Parameters: <span style="color:#1E90FF"> To caculate the risk value for an asset, we will need 4 parameters:Asset, Likelihood, Impact, Control Effectiveness. <span style="color:#1E90FF">
## 3) Likelihood 
